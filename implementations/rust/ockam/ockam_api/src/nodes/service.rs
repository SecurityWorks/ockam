...
impl NodeManager {
    ...
    pub fn credential_retriever_options(&self) -> &NodeManagerCredentialRetrieverOptions {
        &self.credential_retriever_options
    }
...
impl NodeManager {
    ...
    pub async fn create(
        ...
        let mut s = Self {
            ...
            secure_channels,
            credential_retriever_options: trust_options.credential_retriever_options,

...
use ockam::identity::{RemoteCredentialRetriever, TrustEveryonePolicy};
...
use crate::nodes::service::NodeManagerCredentialRetrieverOptions;
...
impl NodeManager {
    ...
    pub(crate) async fn create_secure_channel_internal(
        ...
        let options = match &self.credential_retriever_options {
            NodeManagerCredentialRetrieverOptions::None => options,
            NodeManagerCredentialRetrieverOptions::Remote(info) => options
                .with_credential_retriever(Arc::new(RemoteCredentialRetriever::new(
